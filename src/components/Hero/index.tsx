...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className={`relative min-h-screen flex z-10 overflow-hidden bg-white pb-16 pt-[120px] dark:bg-gray-dark md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]`}
      >
          ...
          <div className="mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto ">
                <h1
                  className={`${isVisible ? "slide-up" : ""} uppercase mb-5 text-4xl lg:text-8xl   font-normal leading-tight text-white dark:text-white`} //  sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight
                >

    ...
    <>
      ...
      >
        <div className="container-full px-10">
          <h2
            className={`text-sm mt-10  tracking-widest uppercase text-gray-500 dark:text-white sm:text-lg md:text-[16px]`}
          >
            Our values
          </h2>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-0 md:gap-10">
            <div className="max-w-lg sm:max-w-2xl">
              <h4 className="text-primary font-normal text-xl sm:text-2xl  md:text-4xl py-5 ">

...
const Latest = () => {
  ...
  return (
    <>
      <section id="collage" className="h-screen">
        <div className="h-1/5">
          <div className="h-full flex flex-col justify-end">
            <h1 className="uppercase primary-font text-2xl sm:text-3xl md:text-4xl xl:text-5xl sm:p-4 sm:px-8 border-black border-t border-b-1">
              THE LATEST
            </h1>
          </div>
        </div>
        <div className="h-3/4">
          <div className="grid h-full grid-cols-1 md:grid-cols-2">
            <div className="flex flex-col justify-between border-black border p-8">
              <h1 className={`max-w-xl font-bold text-2xl sm:text-2xl`}>
                Vogue Business Names AM's Saqib Sohail to Innovators List
              </h1>
              <h5 className="max-w-2xl mt-14 text-sm sm:text-2xl grow">
            ...
            <div className="flex flex-col justify-between border-black border p-8">
              <h1 className={`max-w-2xl font-bold text-2xl sm:text-2xl`}>
